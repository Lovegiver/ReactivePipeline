...
But we can also imagine operations as a tree in which methods A and B are independant, so parallelized, and both producing a result which C deserves.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTYzNzQwODEwLDU1NDczMDU4NywxMDQ5MD
