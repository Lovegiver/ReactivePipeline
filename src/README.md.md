...
Or, at the opposite, a A function producing a result_A which will be consumed by B and C as soon as it will be available : B(result_A) and C(resul
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MjE4MjgyNTksNTU0NzMwNTg3LDEwND
